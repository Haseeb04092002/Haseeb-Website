        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="<?= base_url('assets/images/jaunt01.png');?>" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="<?= base_url('assets/images/jaunt02.png');?>" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="<?= base_url('assets/images/jaunt03.png');?>" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="<?= base_url('assets/images/jaunt04.png');?>" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="<?= base_url('assets/images/jaunt05.png');?>" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="<?= base_url('assets/images/jaunt06.png');?>" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              <h3>Jaunt Solutions Official Website</h3>
              <ul>
                <li><strong>Category</strong>: Official Website</li>
                <li><strong>Client</strong>: JauntSolutions Software Company</li>
                <li><strong>Project URL</strong>: <a target="_blank" href="https://jauntsolutions.com">Click here</a></li>
              </ul>
              <h3 class="mt-3">Description</h3>
              <p>
                Jaunt Solutions is a software company karachi. Jaunt Solutions is a global leader in SAP Business One solutions, committed to prioritizing client needs. Leveraging their expertise and innovative technology, they streamline business processes, enhance efficiency, and drive growth.
              </p>
